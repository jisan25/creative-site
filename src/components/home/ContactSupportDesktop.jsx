const ContactSupportDesktop = () => {
  return (
    <div className="row support-contact-follow-desktop">
      <div className="col-lg-6 support-qrcode">
        <div
          className="bg-primary text-white text-center py-2 m-auto"
          style={{ fontSize: "17px", width: "55%" }}
        >
      ...
      <div className="col-lg-6">
        {/* customer care */}
        <div className="text-center mt-5 mb-0 pt-2">
        ...
        <div className="navbar-social-links mt-4">
...
export default ContactSupportDesktop;
